...
class DensityBucket(str, Enum):
    ...
    See the `screen densities guide <https://developer.android.com/training/multiscreen/screendensities>`_.
    ...
    @property
    def dpi(self) -> int:
        """The raw dpi value this bucket represents (e.g. ``320`` for :attr:`XHDPI`)."""
...
class ScreenSize(str, Enum):
    ...
    See the `supports-screens docs <https://developer.android.com/guide/topics/manifest/supports-screens-element>`_.
    """
...
class Icon:
    ...
    Attributes:
        ...
        bucket: The named density bucket this icon was compiled for (:data:`DensityBucket.ANY` for
        ...
        path: The in-archive path to this icon's file (e.g. ``"res/mipmap-xxhdpi/ic_launcher.png"``).
            May be an XML file (an `adaptive icon
            <https://developer.android.com/develop/ui/views/launch/icon_design_adaptive>`_
            descriptor) rather than a raster image when :attr:`bucket` is :attr:`DensityBucket.ANY`.
    """
